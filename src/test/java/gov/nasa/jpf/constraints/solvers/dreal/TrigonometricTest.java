...
public class TrigonometricTest {
  ...
  public static void main(String[] args) {
    new TrigonometricTest().identityTest();
  }
  
	private void testSimpleTrig(UnaryDoubleFunction trig) {
		DrealSolver solver = TstUtil.createDrealSolver(new Properties());
		...
		TstUtil.runTest(solver, expr, Result.SAT, TstUtil.PRINT_DREAL_EXPR);
	}
/*
	@Test
...
*/
	...
	public void constSin() {
	  DrealSolver solver = TstUtil.createDrealSolver(new Properties());
		...
		TstUtil.runTest(solver, expr, Result.UNSAT, TstUtil.PRINT_DREAL_EXPR);
	}
/*
	@Test
